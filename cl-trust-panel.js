...
(function () {
  ...
  function inject() {
    ...
    panel.innerHTML = ''
      ...
      + '</style>'
      + '<div class="row">'
      + '<span><i>✓</i><div><strong>Reviewed by a qualified estate planner</strong> before release</div></span>'
      + '<span><i>✓</i><div><strong>You only pay after</strong> reviewing all your answers</div></span>'
      + '<span><i>✓</i><div><strong>Draft returned within 24 hours</strong> of payment</div></span>'
      + '<span><i>✓</i><div><strong>No subscription. No hidden fees.</strong> One fixed price.</div></span>'
      + '</div>'
